...
class Cell:
    ...
    def draw(self, sc):
        ...
        if self.walls['right']:
            pygame.draw.line(sc, pygame.Color('orange'), (x + TILE, y), (x + TILE, y + TILE), self.thickness)
        if self.walls['bottom']:
            pygame.draw.line(sc, pygame.Color('orange'), (x + TILE, y + TILE), (x , y + TILE), self.thickness)
        if self.walls['left']:
            pygame.draw.line(sc, pygame.Color('orange'), (x, y + TILE), (x, y), self.thickness)
